...
@interface MyExercisesTableController ()
...
@implementation MyExercisesTableController
...
-(void)retrieveFromParse {
    ...
    PFObject *faveData = [PFObject objectWithClassName:@"User"];
    PFRelation *relation = [faveData relationForKey:@"Exercises"];
    PFQuery *faveExercisesQuery = [relation query];
    [faveExercisesQuery whereKey:@"objectId" equalTo:@"FavouriteExercises"];
    [faveExercisesQuery whereKey:@"FavouriteExercises" equalTo:[PFUser currentUser]];
}
